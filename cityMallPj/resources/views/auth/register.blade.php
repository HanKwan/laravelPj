    ...
    <div class="col-md-5">
        ...
        <form class="container border py-2 px-4" action="/register" method="post">
            ...
            <div class="mb-2">
                ...
                <input class="w-100 border @error('name') border-danger @enderror" type="name" name="name" id="name" value="{{ old('name') }}">
                @error('name')
            ...
            <div class="mb-2">
                ...
                <input class="w-100 border" type="password" name="password_confirmation" id="password_confirmation">
            </div>
